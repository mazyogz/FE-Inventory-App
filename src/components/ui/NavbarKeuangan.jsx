...
const navigation = [
  { name: 'Home', href: '/keuangan/dashboard', icon: HomeIcon, current: true },
  { name: 'Events', href: '/keuangan/dashboard', icon: ClockIcon, current: false },
]
...
export default function NavbarKeuangan() {
    ...
    <>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
          ...
          <div className="flex flex-grow flex-col overflow-y-auto bg-cyan-700 pb-4 pt-5">
            <div className="flex flex-shrink-0 items-center px-4">
            <h1 className="mt-6 text-center text-3xl font-bold leading-9 tracking-tight italic text-cyan-300">
                INVEN
              </h1>
            </div>
